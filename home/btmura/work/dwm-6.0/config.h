...
static Key keys[] = {
  ...
  { MODKEY,                       XK_F8,     spawn,          SHCMD("amixer -q set PCM mute") },
  { MODKEY,                       XK_F9,     spawn,          SHCMD("amixer -q set PCM unmute && amixer -q set PCM 5dB-") },
  { MODKEY,                       XK_F10,    spawn,          SHCMD("amixer -q set PCM unmute && amixer -q set PCM 5dB+") },
